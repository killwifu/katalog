    ...
    <section className="wrap">
      ...
      <aside>
        ...
        <div className={styles.limit}>
          {/* Обработки нет — обещать дневную норму и пакетный режим
              «прямо в альбомах» нельзя: ни того, ни другого пока не
              существует. Оставляем то, что правда работает. */}
          <b>Скоро — обработка фотографий</b>
          <p>
            Витрину можно создать уже сейчас: загружайте фотографии пачками,
            подписывайте и отправляйте ссылку покупателям.
          </p>
