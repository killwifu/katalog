...
const FAQ = [
  {
    ...
    a: 'Ещё 14 дней витрина работает для покупателей как обычно, только загрузка новых фото недоступна. Потом витрина скрывается, а по старой ссылке покупатель видит страницу с вашими контактами. Фотографии и альбомы хранятся в кабинете 3 месяца — возобновите подписку, и витрина откроется в прежнем виде.',
  },
  {
  ...
  },
  {
    ...
    a: 'Перейдите на старший тариф — место и лимит фотографий увеличатся сразу. Отдельно место не докупается.',
  },
  {
    q: 'Как оплатить?',
    a: 'Российской картой или через СБП. Дальше списывается автоматически раз в 30 дней; отключить автосписание можно в кабинете.',
  },
]
    ...
    <>
      <main>
        <section className={styles.top}>
          <div className="wrap">
            ...
            <p>
              Просмотры витрины не ограничены ни на одном тарифе, а возможности одинаковые:
              тарифы отличаются только объёмом. Начать можно бесплатно и без карты.
            </p>
          </div>
        </section>
        ...
        <section className="section">
          <div className="wrap">
            <div className="section__head">
              ...
              <p>
                Тариф можно повысить в любой момент. Возможности на всех тарифах одинаковые —
                различается только объём.
              </p>
            </div>
      ...
      {featured && (
        <StickyBar
          ...
          note="бесплатный тариф — без карты"
          action="Начать"
          href="/app/register"
        />
      )}
